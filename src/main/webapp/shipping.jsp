<html lang="en">
  <head>
    ...
    <title>Ecommerce Template : Product</title>
...
<div class="container">
	...
	<p align="center">
         ...
         <center> 
				...
				<br>
                    ...
                    <label class="control-label">City / Town</label>
                        ...
                        <input id="city" name="city" type="text" placeholder="city" class="input-xlarge"size="135">
                        <p class="help-block"></p>
						</center> 
                    </div>
					<br>
		...
		<center> <a href="#" class="btn btn-success">Confirm</a></center> 
		<br>
		<br>
		<br>
		<footer>
